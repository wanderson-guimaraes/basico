...
class DateFieldsAssetsTestCase extends WP_UnitTestCase {
	...
	function testDateFieldAssets() {
		...
		$field = new adgalleryCMB_Date_Field( 'foo', 'Title', array() );		
			
		// Register adgalleryCMB-Scripts as this is a dependency.
		wp_register_script( 'adgallerycmb-scripts', trailingslashit( adgalleryCMB_URL ) . 'js/cmb.js', array( 'jquery' ) );
	...
	function testTimeFieldAssets() {
		...
		$field = new adgalleryCMB_Time_Field( 'foo', 'Title', array() );		
		...
		// Scripts
		$this->assertContains( adgalleryCMB_URL . '/js/cmb.js', $scripts_output );
		$this->assertContains( adgalleryCMB_URL . '/js/jquery.timePicker.min.js', $scripts_output );
		$this->assertContains( adgalleryCMB_URL . '/js/field.datetime.js', $scripts_output );
			
	}

	function testDateTimestampFieldAssets() {

		$field = new adgalleryCMB_Date_Timestamp_Field( 'foo', 'Title', array() );		
	...
	function testDatetimeTimestampFieldAssets() {
		...
		$field = new adgalleryCMB_Datetime_Timestamp_Field( 'foo', 'Title', array() );		
