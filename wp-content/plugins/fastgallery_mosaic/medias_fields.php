<?php
$attchments_fastgallery_mosaic_options = array(    
    'custom_url' => array(
        'label'       => __('Custom Url', 'fastgallery_mosaic'),
        'input'       => 'text',
        'application' => 'image',
...
Class fastgallery_mosaic_Custom_Medias_Fields {
...
$fgcmf = new fastgallery_mosaic_Custom_Medias_Fields($attchments_fastgallery_mosaic_options);