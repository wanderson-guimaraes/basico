                        ...
                        case "no_lightbox" :
                           ...
                           case "foo_box_free_edition":
                              if ($pic["image_title"] == "" && $pic["image_description"] == "") {
                                 ...
                                 ?>
                                 <img src="<?php echo $pic["file_type"] == "image" ? $filename_thumbs : esc_attr($pic["video_thumb"]); ?>" alt="<?php echo $pic["alt_text"] ?>" image_full_path="<?php echo $pic["file_type"] == "image" ? $filename_original_path : esc_attr($pic["video_thumb"]); ?>"  id="ux_gb_file_<?php echo $random . "_" . $pic["id"]; ?>" name="ux_gb_file" />
                              </a>
                              </div>
                              <?php
                              if ($pic["image_title"] != "" || $pic["image_description"] != "") {
