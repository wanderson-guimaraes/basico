                           ...
                           <div class="tab-content">
                              <div class="tab-pane active" id="general">
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="ux_txt_background_color" id="ux_txt_background_color" placeholder="<?php echo $gb_lightbox_colorbox_background_color_placeholder; ?>" onfocus="color_picker_gallery_bank(this, this.value)" value="<?php echo isset($manage_slideshow_data["slideshow_layout_general_background_color"]) ? esc_attr($manage_slideshow_data["slideshow_layout_general_background_color"]) : "#ffffff"; ?>" >
                                 </div>
                                 <div class="row">
                                    <div class="col-md-6">
                                       <div class="form-group">
